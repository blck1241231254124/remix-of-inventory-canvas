...
export const incomingGoodsApi = {
  ...
  approve: (id: string, userId: string, signatureImage: string): Promise<IncomingGoods> => 
    apiClient.post(`/incoming-goods/${id}/approve`, { userId, signatureImage }),

  reject: (id: string, userId: string, reason: string): Promise<IncomingGoods> => 
    apiClient.post(`/incoming-goods/${id}/reject`, { userId, reason }),
...
export const outgoingGoodsApi = {
  ...
  approve: (id: string, userId: string, signatureImage: string): Promise<OutgoingGoods> => 
    apiClient.post(`/outgoing-goods/${id}/approve`, { userId, signatureImage }),

  reject: (id: string, userId: string, reason: string): Promise<OutgoingGoods> => 
    apiClient.post(`/outgoing-goods/${id}/reject`, { userId, reason }),
...
export const itemRequestApi = {
  ...
  approve: (id: string, userId: string, signatureImage: string): Promise<ItemRequest> => 
    apiClient.post(`/item-requests/${id}/approve`, { userId, signatureImage }),

  reject: (id: string, userId: string, reason: string): Promise<ItemRequest> => 
    apiClient.post(`/item-requests/${id}/reject`, { userId, reason }),
...
export const purchaseOrderApi = {
  ...
  approve: (id: string, userId: string, signatureImage: string): Promise<PurchaseOrder> => 
    apiClient.post(`/purchase-orders/${id}/approve`, { userId, signatureImage }),

  reject: (id: string, userId: string, reason: string): Promise<PurchaseOrder> => 
    apiClient.post(`/purchase-orders/${id}/reject`, { userId, reason }),
